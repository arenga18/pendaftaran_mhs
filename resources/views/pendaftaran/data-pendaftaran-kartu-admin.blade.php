                    ...
                    <div class="p-4">
                        <div class="d-flex">
                            <div class="col-lg-3" style="text-align: center; margin-right:25px; margin-left:25px;">
                                <img width="110px" src="{{ asset('sipenmaru/images/nav.png') }}" alt="">
                            </div>
                            <div class="col-lg-6">
                                <center>
                                    ...
                                    <h5 style="margin-top: -0.5rem"> <strong class="d-block">PENERIMAAN MAHASISWA BARU</strong></h4>
                                        <h4 style="margin-top: -0.5rem"><strong class="d-block">EMPIRE STATE UNIVERSITY</strong></h3>
                                            <p style="margin-top: -0.5rem"><strong class="d-block">Sukamaju, Kec. Sukasuka, Kabupaten
                                                Sukamaju, Belanda <br> 41152</strong></p>
                                </center>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-4" style="border-top: 2px solid black!important; margin-top:-2.5rem;">
                            ...
                            <div class="mb-4">
                                ...
                                <h5 style="text-indent: 0.5in;text-align: justify;">Saya yang menyatakan bahwa data yang
                                    saya isikan dalam formulir pendaftaran penerimaan mahasiswa baru Empire State University tahun 2023 adalah benar dan saya bersedia menerima ketentuan yang berlaku. Saya
