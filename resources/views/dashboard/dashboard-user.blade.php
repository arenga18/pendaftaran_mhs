...
<div class="row page-titles" style="border-radius: 0%">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">PMB ESU</a></li>
    </ol>
</div>
<div class="row">
    <div class="col-xl-7">
                ...
                <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/univ.jpg') }}"
                                alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('sipenmaru/images/ngobrol.jpg') }}"
                                alt="Second slide">
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-lg-6  col-md-6 col-xxl-5 ">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade show active" id="first">
                                        <img class="img-fluid" src="{{ asset('sipenmaru/images/potrait.jpg') }}" alt="">
                                    </div>
